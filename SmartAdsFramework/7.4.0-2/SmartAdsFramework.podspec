...
Pod::Spec.new do |s|
  ...
  # RELEASE START
  s.source = { http: 'https://cocoapods-gazeus.s3.amazonaws.com/cocoapods-gazeus/SmartAdsFramework/Snapshots/7.4.0-2/0b7ac4c3-ef44-4acd-be16-14d7fcd06813/SmartAdsFramework.zip' }
  ...
  s.dependency 'AppLovinMediationFyberAdapter', '~> 8.2.0.1' # 13-04-2023
