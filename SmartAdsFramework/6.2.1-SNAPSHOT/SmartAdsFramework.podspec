...
Pod::Spec.new do |s|
  ...
  s.source = { http: 'https://cocoapods-gazeus.s3.amazonaws.com/cocoapods-gazeus/SmartAdsFramework/Snapshots/6.2.1-SNAPSHOT/19b376cd-2f17-425a-be3a-db2f9ecaa9b3/SmartAdsFramework.zip' }
