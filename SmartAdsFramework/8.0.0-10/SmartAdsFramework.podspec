...
Pod::Spec.new do |s|
  ...
  # RELEASE START
  s.source = { http: 'https://cocoapods-gazeus.s3.amazonaws.com/cocoapods-gazeus/SmartAdsFramework/Snapshots/8.0.0-10/6c8e3670-c047-49c2-a06c-18c3100d718c/SmartAdsFramework.zip' }
  ...
  #*---------------------------------------------* X3M *---------------------------------------------*
  s.dependency 'XMediatorObjC'
  s.dependency 'XMediatorAdColony'
  s.dependency 'XMediatorAdView'
  s.dependency 'XMediatorAPS'
  s.dependency 'XMediatorChartboost'
  s.dependency 'XMediatorHelium'
  s.dependency 'ChartboostMediationAdapterChartboost'
  s.dependency 'XMediatorCriteo'
  #s.dependency 'XMediatorRenderer'
  s.dependency 'XMediatorFyber'
  s.dependency 'XMediatorGoogleAds'
  s.dependency 'ChartboostMediationAdapterGoogleBidding'
  s.dependency 'XMediatorHyprMX'
  s.dependency 'XMediatorInMobi'
  s.dependency 'XMediatorIronSource'
  s.dependency 'XMediatorVungle'
  s.dependency 'GoogleMobileAdsMediationFacebook'
  s.dependency 'XMediatorMintegral'
  s.dependency 'XMediatorOgury'
  s.dependency 'XMediatorPangle'
  s.dependency 'XMediatorRichAudience'
  s.dependency 'XMediatorStack'
  s.dependency 'XMediatorStartio'
  s.dependency 'XMediatorTapjoy'
  s.dependency 'XMediatorTappx'
  s.dependency 'XMediatorUnityAds'
end
