...
Pod::Spec.new do |s|
  ...
  s.version = '6.0.0-SNAPSHOT'
  s.summary = 'SmartAds exibe banners standard e interstitial.'
  s.homepage = 'https://gitlab.gazeus.com/ios-libs/ios-framework-appengine'
  s.author = { 'Name' => 'agomes@gazeus.com' }
  s.license = { type: 'Comercial', text: 'Desenvolvido e licenciado pela Gazeus. Copyright 2018 Gazeus. Todos os direitos reservados.' }
  s.platform = :ios
  s.source = { http: 'https://cocoapods-gazeus.s3.amazonaws.com/cocoapods-gazeus/SmartAdsFramework/Snapshots/6.0.0-SNAPSHOT/89ef5c90-2d18-4fc5-888d-1e962f024944/SmartAdsFramework.zip' }
  ...
  s.dependency 'IronSourceSDK',                       '7.1.5.0' # 11-05-21
  ...
  s.dependency 'GoogleMobileAdsMediationIronSource',  '~> 7.1.5.0'  # 11-05-21
