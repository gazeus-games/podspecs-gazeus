...
Pod::Spec.new do |s|
  ...
  # RELEASE START
  s.source = { http: 'https://cocoapods-gazeus.s3.amazonaws.com/cocoapods-gazeus/SmartAdsFramework/Snapshots/7.0.0-NOFYBER/002dbf7e-d734-46c7-9787-a9d4ccd54738/SmartAdsFramework.zip' }
  ...
  # s.dependency 'AppLovinMediationFyberAdapter', '~> 8.1.3.2' # 24-03-2022        # CRASHA
  ...
  s.dependency 'AppLovinMediationInMobiAdapter', '~> 10.0.2.1' # 24-03-2022      # NAO CRASHA, SO DA EXCEPTION
