...
Pod::Spec.new do |s|
  ...
  # RELEASE START
  s.source = { http: 'https://cocoapods-gazeus.s3.amazonaws.com/cocoapods-gazeus/SmartAdsFramework/Snapshots/9.4.0-15/b0eee979-e27d-486c-952d-1155fbf476b0/SmartAdsFramework.zip' }
  ...
  s.dependency 'AppLovinMediationUnityAdsAdapter', '4.18.1.0'
  ...
  s.dependency 'XMediatorUnityAds', '4.18.1.0'
