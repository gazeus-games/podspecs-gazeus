...
Pod::Spec.new do |s|
  ...
  # RELEASE START
  s.source = { http: 'https://cocoapods-gazeus.s3.amazonaws.com/cocoapods-gazeus/SmartAdsFramework/Snapshots/7.4.4-2/d4bfaa41-f603-4c39-a860-fe01153673a7/SmartAdsFramework.zip' }
  ...
  s.dependency 'AppLovinMediationByteDanceAdapter', '~> 5.5.0.6.0' # 18-08-2023
  s.dependency 'AppLovinMediationChartboostAdapter', '~> 9.4.0.1' # 18-08-2023
  ...
  s.dependency 'AppLovinMediationGoogleAdManagerAdapter', '~> 10.11.0.0' # 18-08-2023
  s.dependency 'AppLovinMediationGoogleAdapter', '~> 10.11.0.0' # 18-08-2023
  ...
  s.dependency 'AppLovinMediationUnityAdsAdapter', '~> 4.9.0.0' # 18-08-2023
