...
Pod::Spec.new do |s|
  ...
  # RELEASE START
  s.source = { http: 'https://cocoapods-gazeus.s3.amazonaws.com/cocoapods-gazeus/SmartAdsFramework/Snapshots/9.9.0-11/92fd9d57-2d7d-44f5-a779-0868f2ce1fd2/SmartAdsFramework.zip' }
  ...
  s.dependency 'GoogleMobileAdsMediationMoloco', '3.10.1.0'
end
