...
s.version = '4.5.4'
  ...
  s.platform = :ios
s.source = { :http => 'https://s3.amazonaws.com/cocoapods-gazeus/SmartAdsFramework/Releases/4.5.4/SmartAdsFramework-1544015858.zip' }
  ...
  s.dependency 'G47ppH93', '0.7.12' # AppOnboard
end
