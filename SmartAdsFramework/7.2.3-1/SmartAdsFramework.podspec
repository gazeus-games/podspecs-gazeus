...
Pod::Spec.new do |s|
  ...
  # RELEASE START
  s.source = { http: 'https://cocoapods-gazeus.s3.amazonaws.com/cocoapods-gazeus/SmartAdsFramework/Snapshots/7.2.3-1/60a3ca56-d57f-4184-a508-563fe120fdf0/SmartAdsFramework.zip' }
  ...
  s.dependency 'AppEngine', '~> 1.6.4-1'
