...
Pod::Spec.new do |s|
  ...
  # RELEASE START
  s.source = { http: 'https://cocoapods-gazeus.s3.amazonaws.com/cocoapods-gazeus/SmartAdsFramework/Snapshots/9.2.0-2/6b2d542f-fa11-4d9b-ba28-66edd21c26d7/SmartAdsFramework.zip' }
  ...
  s.dependency 'AppLovinMediationMolocoAdapter', '3.13.0.0'
  ...
  s.dependency 'GoogleMobileAdsMediationFyber', '8.3.8.0'
  ...
  s.dependency 'GoogleMobileAdsMediationMoloco', '3.13.0.0'
  s.dependency 'OguryMediationGoogleMobileAds', '5.0.2.0'
end
