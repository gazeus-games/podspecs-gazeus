...
s.version = '5.4.4-SNAPSHOT'
  ...
  s.platform = :ios
s.source = { :http => 'https://s3.amazonaws.com/cocoapods-gazeus/SmartAdsFramework/Snapshots/5.4.4/SmartAdsFramework-1588100176.zip' }
  s.ios.deployment_target = '9.0'
  s.ios.vendored_frameworks = 'SmartAdsFramework.framework'
  s.dependency 'AppEngine', '~> 1.4.30'
  s.dependency 'GoogleMobileAdsMediationAppLovin', '~> 6.12.0.0'
  s.dependency 'GoogleMobileAdsMediationFacebook', '~> 5.8.0.1'
  s.dependency 'AdColony', '4.1.4'
  s.dependency 'AppLovinSDK', '6.12.0'
