...
Pod::Spec.new do |s|
  ...
  s.platform = :ios
  s.source = { http: 'https://cocoapods-gazeus.s3.amazonaws.com/cocoapods-gazeus/AnalyticsBroker/Snapshots/1.6.2-SNAPSHOT/f8982139-6b60-4317-92a0-dc200d5adca8/AnalyticsBroker.zip' }
