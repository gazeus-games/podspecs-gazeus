...
s.version = '1.3.4'
  ...
  s.platform = :ios
s.source = { :http => 'https://s3.amazonaws.com/cocoapods-gazeus/AnalyticsBroker/Releases/1.3.4/AnalyticsBroker-1581679065.zip' }
  ...
  s.dependency 'Firebase/Analytics', '6.16.0'
  s.dependency 'Firebase/Core', '6.16.0'
