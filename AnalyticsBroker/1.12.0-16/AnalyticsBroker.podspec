...
Pod::Spec.new do |s|
  ...
  # RELEASE START
  s.source = { http: 'https://cocoapods-gazeus.s3.amazonaws.com/cocoapods-gazeus/AnalyticsBroker/Snapshots/1.12.0-16/e30d18c1-0532-4e8c-b5b3-40bf93b84682/AnalyticsBroker.zip' }
  ...
  s.dependency 'AppEngine', '>= 1.8.0-1'
