...
Pod::Spec.new do |s|
  ...
  # RELEASE START
  s.source = { http: 'https://cocoapods-gazeus.s3.amazonaws.com/cocoapods-gazeus/AnalyticsBroker/Snapshots/1.6.4-1/c6175099-ba85-44da-b934-622c606da0b7/AnalyticsBroker.zip' }
  ...
  s.dependency 'AppEngine', '>= 1.6.4-0'
